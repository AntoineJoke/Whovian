...
class ArticleFormView {
	...
	public static function getDefaultFormHTML($action){
 	...
 	public static function getDefaultFormHTMLEdition($action){
		return self::getFormHtmlEdition($action,Article::getDefaultArticle( )) ;
	}

 	public static function getFormHtmlEdition ($action,$article) {
 		$htmlCode = FormManager ::beginForm("post", $action ) ;
